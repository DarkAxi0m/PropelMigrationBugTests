...
CREATE TABLE `company` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `IX_UQ_company_id` (`id`),
  UNIQUE KEY `IX_UQ_company_hash` (`hash`),
...
INSERT INTO `propel_migration` VALUES (1462928478),(1462928479),(1462928480);
...
-- Dump completed on 2016-05-11 10:33:09
